...
const PaymentAddCard = memo(({ route }: any) => {
  ...
  const [isShowKeyboard, setIsShowKeyboard] = useState<boolean>(true);
  ...
  const onSetCardNumber = useCallback(
    (text: string) => {
      let cardTemp: string = "";
    ...
    <Container style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          style={styles.touch}
          activeOpacity={0.54}
          onPress={() => setIsShowKeyboard(!isShowKeyboard)}
        >
        ...
        <View style={styles.date}>
          ...
          {isShowCVV ? (
            ...
            >
              <View style={styles.icon}>
                <Layout style={styles.icon1}></Layout>
              </View>
              <View style={styles.icon}>
                <Layout style={styles.icon1}></Layout>
              </View>
      ...
      {isShowKeyboard && (
        <View>
          <Text size={13} lineHeight={16} marginTop={scale(24)}>
            Card Number
          </Text>
          <TextInput
            style={[styles.inputCard, { color: theme.text }]}
            value={cardNumber}
      ...
      <View
        style={[
          styles.frameSpaceBottom,
          { bottom: keyboardHeight == 0 ? 0 : keyboardHeight + scale(100) },
        ]}
      >
        <ButtonLinear
          white
