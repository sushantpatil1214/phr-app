...
export default memo(({ route }: any) => {
  ...
  return (
    <Container>
            ...
            <SubtitleItem icon="help" title="Consult Details">
              <View>
                ...
                <View style={styles.doctorAnswer}>
                  ...
                  <Layout style={styles.prescription}>
                    <Text
                      bold
                      size={15}
                      lineHeight={18}
      ...
      <View
        style={[styles.buttonBottom, { backgroundColor: theme.backgroundItem }]}
      >
        <ButtonLinear title="Write A Review" white />
      </View>
    </Container>
  );
});
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 16,
    paddingBottom: getBottomSpace() + scale(123),
  },
  myQuestion: {
    paddingBottom: 24,
    borderBottomWidth: 1,
