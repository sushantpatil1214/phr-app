...
export default memo(() => {
  ...
  return (
    ...
    >
      ...
      <Layout style={styles.contentView}>
        ...
        <View style={styles.content}>
          ...
          <TextInput
            ...
            editable
            isShowIconLeft
            isShowIcon={contactEmail.length != 0}
            onChangeText={onChangeEmail}
            icon={
              <TouchableOpacity
                activeOpacity={0.54}
                style={[
                  styles.iconCloseStyle,
          ...
          <View style={Theme.flexRow}>
            <TouchableOpacity
              ...
              style={[
                styles.touchSpace,
                { width: 112, borderColor: theme.borderColor },
              ]}
      ...
      <Layout style={[styles.contentLastView]}>
        <View style={styles.contentHeader}>
        ...
        <View style={styles.content}>
          ...
          <TextInput
            ...
            isShowIconLeft
            isShowIcon={emergencyContactName.length != 0}
            icon={
              <TouchableOpacity
                activeOpacity={0.54}
...
const styles = StyleSheet.create({
  ...
  contentLastView: {
    borderRadius: 16,
    paddingTop: 16,
    marginBottom: getBottomSpace() + scale(40),
    paddingBottom: scale(32),
  },
  contentHeader: {
    ...Theme.flexRow,
